...
#include "Harris3DCharacter.generated.h"

UCLASS(config=Game)
class AHarris3DCharacter : public ACharacter
{
	GENERATED_BODY()
...
public:
	...
	Eigen::MatrixXd nhd_matrix = Eigen::MatrixXd (3, 3);

	double x_vertex = nhd_matrix(0, 2-1);
};
